      ...
      <div className="mx-auto max-w-6xl px-5 py-12">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          <div className="flex flex-col gap-3">
            <img src="/METlogo.png" alt="MET" className="h-9 w-auto opacity-80" />
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-xs font-display font-bold tracking-[0.22em] uppercase text-white/60">Pages</h3>
            <nav aria-label="Footer navigation">
              <ul className="flex flex-col gap-1.5">
                {footerLinks.map(({ to, label }) => (
                  <li key={to}>
                    <Link to={to} className="text-xs text-muted hover:text-white transition-colors duration-200">
                      {label}
                    </Link>
                  </li>
                ))}
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-xs font-display font-bold tracking-[0.22em] uppercase text-white/60">Operations</h3>
            <ul className="flex flex-col gap-1.5 text-xs text-muted">
              <li>
                <span className="text-white/50">Days:</span> {operatingInfo.days}
              </li>
              <li>
                <span className="text-white/50">Hours:</span> {operatingInfo.hours}
              </li>
              <li>
                <span className="text-white/50">Zones:</span> {operatingInfo.zones.join(' - ')}
              </li>
            </ul>
            <p className="mt-2 text-[0.67rem] text-white/30 leading-relaxed">
