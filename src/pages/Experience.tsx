    ...
    <div className="flex flex-col gap-12">
      ...
      <section className="grid gap-6">
        ...
        <p className="max-w-3xl text-base text-offwhite/75">
          MET treats the ride as part of the night without compromising safety or discipline. Interiors are designed to
          feel premium and intentional: tasteful lighting, controlled music, clean vehicles, and professional drivers.
        </p>
